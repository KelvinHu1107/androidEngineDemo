...
public class DLG_SEARCH_KIND3 extends Activity
{
	public int m_kind1Idx = 0;
	public int m_kind1Code = 0;
	public int m_kind2Idx = 0;
	public int m_kind2Code = 0;
	public void onCreate(Bundle savedInstanceState)
	{
		...
		m_kind2Idx = intent.getIntExtra("kind2Idx", 0);
		m_kind2Code = intent.getIntExtra("kind2Code", 0);
		makeBtnText();
		
		Button btnHome = (Button)findViewById(R.id.btnMap);
		btnHome.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(DLG_SEARCH_KIND3.this, MapViewActivity.class);
	...
	private void makeBtnText()
	{
		...
		int kindNum = citus_api.NDB_Kind_GetChildNum(m_kind2Idx);
		...
		for(int i=0;i<16;i++)
		{
			...
			else
			{
				...
				citus_api.NDB_Kind_GetChildInfo(m_kind2Idx, i-1, info);
				btn.setText(new String(info.kind3_name));
			...
			btn.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v)
				{
					...
					if(tag == 0)
					{
						Intent intent = new Intent(DLG_SEARCH_KIND3.this, DLG_SEARCH_KIND_LIST.class);
						intent.putExtra("kindcode", m_kind2Code);
						startActivity(intent);
					}
					else
					{
						Intent intent = new Intent(DLG_SEARCH_KIND3.this, DLG_SEARCH_KIND_LIST.class);
						intent.putExtra("kindcode", iTag);
						startActivity(intent);
					}
				}
			});
	...
	{
		new AlertDialog.Builder(DLG_SEARCH_KIND3.this)
		.setTitle("알림")
	    .setMessage(_msg)

...
public class DLG_SEARCH_UBCODE_LIST extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		btnHome.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(DLG_SEARCH_UBCODE_LIST.this, MapViewActivity.class);
	...
	class ListAdapter extends ArrayAdapter<NDB_RESULT> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			View v = convertView;
			if (v == null) {
				LayoutInflater vi = (LayoutInflater) DLG_SEARCH_UBCODE_LIST.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	...
	private void setListText(View v, int position)
	{
		...
		listText2.setText(item.name1 + "(" + item.distance+"m, dir="+item.angle+")" + "(" + info.address + ")", TextView.BufferType.SPANNABLE);
	...
	private void viewDetail(int idx)
	{
		...
		Intent intent = new Intent(DLG_SEARCH_UBCODE_LIST.this, DLG_VIEW_MAP_SEARCH.class);

...
public class citus_api
{
	...
	// sound info codes
		...
		public static final int  SND_DIR_STRAIGHT	= 0;   //������������������ �����ル�������������� ���������������������������?���������������������������������?
		public static final int	 SND_DIR_RIGHT_1	= 1;   //���������������������������?1���������?������������������
		public static final int	 SND_DIR_RIGHT		= 2;   //���������������������������?������������������ 
		public static final int	 SND_DIR_RIGHT_4	= 3;   //���������������������������?4���������?������������������ 
		public static final int	 SND_DIR_LEFT_11	= 4;   //������������������ 11���������?������������������ 
		public static final int	 SND_DIR_LEFT		= 5;   //������������������ ������������������ 
		public static final int	 SND_DIR_LEFT_8		= 6;   //������������������ 8���������?������������������ 
		public static final int	 SND_DIR_UTURN		= 7;   //U���������?
		public static final int  SND_DIR_PTURN		= 8;	// P-Turn���������������?
		public static final int  SND_DIR_RTURN		= 9;	// ������������������������������������.
		public static final int  SND_DIR_LTURN		= 10;	// ������������������������������������.
		public static final int  SND_DIR_GO_12		= 11;	// 12���������?������������������
		public static final int  SND_DIR_RIGHT_2	= 12;	// ���������������������������?2���������?������������������
		public static final int  SND_DIR_RIGHT_3	= 13;	// ���������������������������?3���������?������������������
		public static final int  SND_DIR_RIGHT_5	= 14;	// ���������������������������?5���������?������������������
		public static final int  SND_DIR_LEFT_10	= 15;	// ������������������ 10���������?
		public static final int  SND_DIR_LEFT_9		= 16;	// ������������������ 9���������?
		public static final int  SND_DIR_LEFT_7		= 17;	// ������������������ 7���������?
...
//	public static final int  SND_INFO_NOT_TO_TUNNEL		= 10;
	...
	public static NDB_RESULT g_res_item = null;// TODO �o�Ӫ��γ~?
	private static Timer timer_2; // TODO �o�Ӫ��γ~?
	public static Mutex m_ndk_lock; // TODO �o�Ӫ��γ~?
	
	public static final int AD_INDEX_AIRWAVES = 101 ;
	
	public static int SetTimer4Native(int delay) // TODO �o�Ӫ��γ~?
    {
...
//    	}
	...
	public static native void BitmapCopy(Bitmap bitmap); // 2d������
	public static native boolean getJunctionViewBitmap(Bitmap outBitmap, WrapInt outWidth, WrapInt outHeight ,WrapString outJunctionNameId); // �괺��	
	...
	public static native boolean	NDB_Result_GetItem(int idx, NDB_RESULT res); // ������������������������������������
	...
	public static native int   		NDB_Kind_GetChildInfo(int _kind_idx, int _seq_idx, NDB_KIND_INFO info);// ������������������������������������
	...
	public static native boolean 	NDB_Kind_GetInfo(int _kind_idx, NDB_KIND_INFO info); // ������������������������������������
	...
	public static native int   		NDB_Admin_GetChildInfo(int res_type, int _admin_idx, int _seq_idx, NDB_ADMIN_INFO info); // ������������������������������������
	public static native int   		NDB_Admin_FindByCode(int res_type, final String code);
	public static native boolean 	NDB_Admin_GetInfo(int res_type, int _admin_idx, NDB_ADMIN_INFO info); // ������������������������������������
	...
	public static native boolean 	NDB_Poi_GetBody(int poi_idx, NDB_POI_BODY_INFO info); // ������������������������������������
	...
	public static native boolean	NDB_Result_Group_GetItem(int group_idx, int idx, NDB_RESULT res); // ������������������������������������
	public static native void		NDB_Reult_StringMark(final String poi_str, int ch_seq, int search_len, WrapInt st_ch, WrapInt ed_ch); // ������������������������������������
	...
	public static native int SYS_ReloadSNDData(String dataPath);//���w�w������
	...
	public static native void MM_SetPlayReRoutingVoice(boolean isPlay);	//�]�w�O�_�������s�W�e���|�y��
